            ...
            <div class="row justify-content-between">
                ...
                <div class="col-6">
                    <div class="card mb-4 box-shadow">
                     <img class="card-img-top" src="{{ asset('image/'.$produit->photo_principale) }}" alt="Card image cap">
    ...
    <div class="album py-5 bg-light">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img src="{{asset('image/.$produit_recommande->photo_principale')}}" class="card-img-top img-fluid" alt="Responsive image">

                        <div class="card-body">
                            <div class="d-flex justify-content-end">
                                <div class="btn-group">
                                    <a href="{{route('voir_produit',['id'=>$produit_recommande->id])}}" class="btn btn-sm btn-outline-secondary">
